                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $no=0;
                    $sql=mysqli_query($koneksi,"SELECT tb_mhs.*,tb_dosen.nm_dosen FROM tb_mhs,tb_dosen where tb_mhs.nip_pembimbing=tb_dosen.nip and stts_hps = '0' and tb_mhs.nim='$_SESSION[id]'");
