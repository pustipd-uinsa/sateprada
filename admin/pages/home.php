            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                <div class="inner">
                    ...
                    $sql=mysqli_query($koneksi,"SELECT * FROM tb_mhs where nip_pembimbing='$id' and stts_hps = '0'");
                    $q=mysqli_num_rows($sql);
                    ?>
                  <h3><?php echo $q; ?></h3>
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                <div class="inner">
                    ...
                    $sql=mysqli_query($koneksi,"SELECT * FROM tb_mhs where prodi='$id' and stts_hps = '0'");
                    $q=mysqli_num_rows($sql);
                    ?>
                  <h3><?php echo $q; ?></h3>
                ...
                <a href="index.php?p=list-mahasiswa-prodi" class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
