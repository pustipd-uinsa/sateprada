            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data List Nilai Akhir Mahasiswa</h3>  
                </div><!-- /.box-header -->
                <div class="box-body">
                  <div class="table-responsive">     
                   <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $no=0;
                      $sql=mysqli_query($koneksi,"SELECT * FROM tb_mhs where nim='$_GET[id]' AND stts_hps = '0'");
                    ...
                    $total1=(int)$q1['penguasaan_bahasa']+(int)$q1['kemampuan_pengembangan']+(int)$q1['penguasaan_kaidah']+(int)$q1['kelengkapan_laporan']+(int)$q1['total_nilai_dos'];
                    $ndos=$total1/1;
