                  ...
                  <div class="table-responsive">     
                   <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $no=0;
                      $sql=mysqli_query($koneksi,"SELECT * FROM tb_mhs,tb_instansi,tb_penempatan,tb_dosen where tb_penempatan.nim=tb_mhs.nim and tb_penempatan.kd_instansi=tb_instansi.kd_instansi and tb_dosen.nip=tb_mhs.nip_pembimbing and tb_mhs.nim='$_GET[id]' and stts_hps = '0'");
