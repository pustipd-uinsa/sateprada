                  ...
                  <div class="table-responsive">     
                   <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $no=0;
                      $sql=mysqli_query($koneksi,"SELECT * FROM tb_mhs,tb_instansi,tb_penempatan where tb_penempatan.nim=tb_mhs.nim and stts_hps = '0' and tb_penempatan.kd_instansi=tb_instansi.kd_instansi and tb_mhs.nim='$_GET[id]'");
                     ...
                     ?>
                      <tr>
                        ...
                        <td><a href="index.php?p=list-instansi-single&idi=<?php echo $q['kd_instansi']; ?>"><?php echo strtoupper($q['nm_instansi']); ?></a></td>
                          ...
                          <td>
                          <a href="./pages/cetak-nilai-instansi.php?nim=<?php echo $q['nim']; ?>&kdi=<?php echo $q['kd_instansi']; ?>" class="btn btn-danger" target="_blank">Cetak Nilai</a>
